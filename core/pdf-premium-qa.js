  ...
  return Object.assign(
    {
      ...
      endereco:'Av. Herminio Ometto, 576',
      cidade:'Leme/SP'
    },
    obj(s.empresa),
    obj(cfg.empresa)
...
function sampleBudget(){
  return {
    ...
    cliente:'CLIENTE REAL / IMPORTADO',
    telefone:'',
    veiculo:'VEÍCULO REAL / IMPORTADO',
    placa:'',
    descricao:'Descrição técnica do serviço a ser executado.',
    complexidade:'Médio / Alto',
    prioridade:'Normal',
    servicos:[
      {descricao:'Funilaria / preparação', qtd:1, valor:0},
      {descricao:'Pintura / acabamento', qtd:1, valor:0}
    ],
    pecas:[],
    materiais:[],
    garantia:'Garantia conforme serviço executado, condições combinadas e uso adequado do veículo.',
    total:0,
    validadeDias:90
  };
}
...
<head>
<meta charset="utf-8">
<title>Orçamento Premium — ${budget.numero}</title>
<style>
