...
import {hydrateState,persistState,clearState,STORAGE_KEY} from './storage.js?v=546116';
import {initRouter} from './router.js?v=546116';
import {SIM} from '../data/simulacao.js?v=546116';
import {mountOrcamento,loadOrcamentoSim,renderOrcamento} from '../modules/orcamento.js?v=546116';
import {mountFinanceiro,renderFinanceiro} from '../modules/financeiro.js?v=546116';
import {mountContas,loadContasSim,renderContas} from '../modules/contas.js?v=546116';
import {mountClientes,renderClientes} from '../modules/clientes.js?v=546116';
import {mountAgenda,renderAgenda} from '../modules/agenda.js?v=546116';
import {mountMetas,renderMetas} from '../modules/metas.js?v=546116';
import {mountRelatorios,renderRelatorios} from '../modules/relatorios.js?v=546116';
import {mountIA,renderIA} from '../modules/ia.js?v=546116';
...
function bootstrap(){
  ...
  console.log('Ofix V546.11.6 DOM-safe/fusão carregado',STATE);
}
