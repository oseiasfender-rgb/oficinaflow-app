...
const VERSION='V547.27 RESPONSIVIDADE';
...
// V547.27 RESPONSIVIDADEmodule CRUD helpers
(function(){
...
// V547.27 RESPONSIVIDADE— Competência Real Engine
(function(){
if(!window.OficinaOS)return;
const OS=window.OficinaOS;
const arr=x=>Array.isArray(x)?x:[];
...
// V547.27 RESPONSIVIDADE— Motor de Contas Real
(function(){
if(!window.OficinaOS)return;
const OS=window.OficinaOS;
const arr=x=>Array.isArray(x)?x:[];
...
// V547.27 RESPONSIVIDADE— Motor de Recorrentes Real
(function(){
if(!window.OficinaOS)return;
const OS=window.OficinaOS;
const arr=x=>Array.isArray(x)?x:[];
...
// V547.27 RESPONSIVIDADEs Financeiros Real
(function(){
if(!window.OficinaOS)return;
const OS=window.OficinaOS;
...
// V547.27 RESPONSIVIDADE— Auditoria Operacional
(function(){
if(!window.OficinaOS)return;
const OS=window.OficinaOS;
const uid=p=>p+'_'+Date.now().toString(36)+Math.random().toString(36).slice(2,7);
...
// V547.27 RESPONSIVIDADE— Central de Alertas
(function(){
if(!window.OficinaOS)return;
const OS=window.OficinaOS;
const arr=x=>Array.isArray(x)?x:[];
...
// V547.27 RESPONSIVIDADE— Busca Global
(function(){
if(!window.OficinaOS)return;
const OS=window.OficinaOS;
const arr=x=>Array.isArray(x)?x:[];
...
// V547.27 RESPONSIVIDADE/V547.27 RESPONSIVIDADEreferências + Painel Operacional
(function(){
if(!window.OficinaOS)return;
